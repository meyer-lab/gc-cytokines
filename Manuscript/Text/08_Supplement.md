...
![**Full panel of predicted versus actual immune cell type responses. Related to Figure 4.** Dots represent experimental flow cytometry measurements and shaded regions represent 10-90% confidence interval for model predictions. Time of pSTAT5 activity measurement is denoted by color. All cell populations were stimulated with either IL-2 (A-J) or IL-15 (K-T). Experiments were performed in duplicate (N = 2).](./Manuscript/Figures/figureS5.svg){#fig:supp5}

![**Cytokine affinity measurements to IL-2Rα. Related to Figure 6.** Binding is quantified in relative units. Affinity was measured using biolayer interferometry.](./Manuscript/CD25binding.pdf){#fig:supp6}

![**Full panel of predicted versus actual immune cell type responses to IL-2 muteins. Related to Figure 6.** Dots represent experimental flow cytometry measurements and shaded regions represent 10-90% confidence interval for model predictions. Time of pSTAT5 activity measurement is denoted by color. Cell populations were stimulated with IL-2 muteins of varying IL-2Rα and IL-2Rβ/γ~c~ binding affinities. Experiments were performed once (N = 1).](./Manuscript/Figures/figureS7.svg){#fig:supp7 height=90%}
